...
const AppMobileBlock: React.FC<AppBlockProps> = ({ title, description }) => {
  ...
  const layers = [
    { ref: appBarRef, translateZ: -200, topOffset: -300 },
    { ref: searchBarRef, translateZ: 100, topOffset: -200 },
    { ref: chipsRef, translateZ: 150, topOffset: -140 },
    { ref: cardRef, translateZ: -250, topOffset: 50 },
    { ref: bottomNavRef, translateZ: 100, topOffset: 260 },
  ];

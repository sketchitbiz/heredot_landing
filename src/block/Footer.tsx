    ...
    <FooterContainer>
      <FooterContent>
        ...
        <InfoSectionWrapper>
          ...
          <InfoSectionRight>
            <Link href={`/terms/${lang === 'ko' ? 'terms' : 'terms_en'}`}>{t.footer.terms}</Link>
            <Link href={`/terms/${lang === 'ko' ? 'privacy' : 'privacy_en'}`}>{t.footer.privacy}</Link>
            <Link href={`/terms/${lang === 'ko' ? 'company' : 'company_en'}`}>{t.footer.companyInfo}</Link>

...
const TEXT = {
  ko: {
    ...
    confirmButtons: [{ title: 'IOS 앱 바로가기', href: 'https://apps.apple.com/pl/app/%EC%97%89%EB%94%B0-%EC%BA%A0%ED%95%91%EC%9A%A9-iot-%EC%95%B1/id1617043292' }],
    volume: '화면 분량 5장 내외',
  ...
  en: {
    projectIntro: 'An IoT app for controlling camping heaters\nSupports BLE-based temperature and heating time control.',
    features: [['[BLE]', 'Connect and control camping heater devices']],
    screenshots: ['Service Web Page'],
    confirmButtons: [{ title: 'Open AOS App', href: 'https://apps.apple.com/pl/app/%EC%97%89%EB%94%B0-%EC%BA%A0%ED%95%91%EC%9A%A9-iot-%EC%95%B1/id1617043292' }],
